...
function FavoriteContactsPage() {
  ...
  const pageContext = 'favoritecontact';

  useEffect(() => {
   dispatch(fetchContacts({
      page: pagination?.currentPage || 1,
      filters: { ...filters, isFavorite: 'YES' }, 
      sort: sort,
    }));
  ...
  const handleDelete = (id) => {
    ...
    dispatch(fetchContacts({
      page: pagination?.currentPage || 1,
      filters: { ...filters, isFavorite: 'YES' }, // Ensure only favorites are fetched
      sort: sort,
    }));
  };
        ...
        <div className="col-lg-12">
          <div className="card shadow-lg rounded-3">
            <div className="card-body p-4">
              <h5 className="card-title text-primary mb-4">Favorite Contacts</h5>
              ...
              {contacts?.length ? (
                ...
                !loading && <p className="text-center mt-3">No favorite contacts available.</p>
              )}
