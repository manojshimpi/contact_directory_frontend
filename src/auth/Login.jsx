...
function Login() {
    ...
    const googleLogin = useGoogleAuth((user, token) => {
                ...
                <div className="row justify-content-center">
                  <div className="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div className="col-12 mt-4">
                        <button onClick={googleLogin} className="btn btn-google w-100 d-flex justify-content-center align-items-center p-3 border rounded-4 shadow-lg">
